...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  @DefaultMessage("<h2>Please fill out a short voluntary survey so that we can learn more about our users and improve DockerSpace.</h2>")
  @Description("")
